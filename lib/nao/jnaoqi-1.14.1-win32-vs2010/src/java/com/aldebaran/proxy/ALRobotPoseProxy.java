...
public class ALRobotPoseProxy extends ALProxy {
 	static {
	...
	/// Default Constructor.
	/// </summary>
	public ALRobotPoseProxy(String ip, int port) {
		super("ALRobotPose", ip, port);
	}
    /// <summary>
    ...
    public Variant getActualPoseAndTime()
    {
	Variant result = call("getActualPoseAndTime" );
	    	return  result;
    }
    /// <summary>
    ...
    public Variant getPoseNames()
    {
	Variant result = call("getPoseNames" );
	    	return  result;
    }
    /// <summary>
