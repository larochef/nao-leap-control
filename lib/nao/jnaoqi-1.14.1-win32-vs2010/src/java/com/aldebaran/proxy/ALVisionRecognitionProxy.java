...
public class ALVisionRecognitionProxy extends ALProxy {
 	static {
	...
	/// Default Constructor.
	/// </summary>
	public ALVisionRecognitionProxy(String ip, int port) {
		super("ALVisionRecognition", ip, port);
	}
    /// <summary>
    ...
    public int changeDatabase( String databasePath,  String databaseName)
    {
	Variant vdatabasePath;
	vdatabasePath = new Variant(databasePath);
	Variant vdatabaseName;
	vdatabaseName = new Variant(databaseName);
	Variant result = call("changeDatabase" ,vdatabasePath, vdatabaseName);
	    	return  result.toInt();
    }
    /// <summary>
    ...
    public void setParam( String paramName,  Variant paramValue)
    {
	Variant vparamName;
	vparamName = new Variant(paramName);
	Variant vparamValue;
	vparamValue = new Variant(paramValue);
	Variant result = call("setParam" ,vparamName, vparamValue);
		// no return value
    }
    /// <summary>
    /// returns true if the method is currently running
