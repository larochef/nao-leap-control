...
public class ALAudioRecorderProxy extends ALProxy {
    ...
    public void startMicrophonesRecording( String filename,  String type,  int samplerate,  Variant channels)
    {
	Variant vfilename;
	...
	Variant result = call("startMicrophonesRecording" ,vfilename, vtype, vsamplerate, vchannels);
		// no return value
    }
    /// <summary>
    /// returns true if the method is currently running
