...
public class ALFaceDetectionProxy extends ALProxy {
 	static {
	...
	/// Default Constructor.
	/// </summary>
	public ALFaceDetectionProxy(String ip, int port) {
		super("ALFaceDetection", ip, port);
	}
    /// <summary>
    ...
    {
	Variant result = call("clearDatabase" );
	...
	Variant result = call("enableRecognition" ,venable);
		// no return value
    }
    /// <summary>
	...
	Variant venable;
	venable = new Variant(enable);
	Variant result = call("enableTracking" ,venable);
		// no return value
    }
    /// <summary>
    ...
    public Boolean forgetPerson( String pId)
    {
	Variant vpId;
	vpId = new Variant(pId);
	Variant result = call("forgetPerson" ,vpId);
	    	return  result.toBoolean();
    }
    /// <summary>
    ...
    {
	Variant result = call("isTrackingEnabled" );
	    	return  result.toBoolean();
    }
    /// <summary>
    ...
    public Boolean learnFace( String pId)
    {
	Variant vpId;
	vpId = new Variant(pId);
	Variant result = call("learnFace" ,vpId);
	    	return  result.toBoolean();
    }
    /// <summary>
    ...
    public Boolean reLearnFace( String pId)
    {
	Variant vpId;
	vpId = new Variant(pId);
	Variant result = call("reLearnFace" ,vpId);
	    	return  result.toBoolean();
    }
    /// <summary>
    /// returns true if the method is currently running
