...
public class ALDarknessDetectionProxy extends ALProxy {
 	static {
	...
	/// Default Constructor.
	/// </summary>
	public ALDarknessDetectionProxy(String ip, int port) {
		super("ALDarknessDetection", ip, port);
	}
    /// <summary>
    ...
    {
	Variant result = call("getDarknessThreshold" );
	    	return  result.toInt();
    }
    /// <summary>
    ...
    public void setDarknessThreshold( int threshold)
    {
	Variant vthreshold;
	vthreshold = new Variant(threshold);
	Variant result = call("setDarknessThreshold" ,vthreshold);
		// no return value
    }
    /// <summary>
